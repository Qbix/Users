(function (Q, $) {
    ...
    Users.Faces =  function Users_Faces (params) {
        ...
        this.landmarksDetection = function () {
            ...
            Q.addScript([
                '{{Users}}/js/models/tf-core.js',
                '{{Users}}/js/models/tf-converter.js',
                '{{Users}}/js/models/tf-backend-webgl.js',
                '{{Users}}/js/models/face-landmarks-detection.js'
            ], function () {
        ...
        this.start = function (callback) {
            ...
            Q.addScript(['{{Users}}/js/models/tfjs.js', '{{Users}}/js/models/blazeface.js'], function () {
                // init blazeface
