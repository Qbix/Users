...
class Users_Quota extends Base_Users_Quota
{
	 ...
	 * @return {Users_Quota|array} if no quotas were exceeded, this object is returned and you can call ->used($units) on it later.
	 *  But if some quotas were exceeded, the function returns the array of corresponding durations, sorted by smallest first.
	 *  So use is_array() with the return value to find out if any quotas were exceeded.
