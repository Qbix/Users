/**
 * Autogenerated base class representing referred rows
 * in the Users database.
 *
 * Don't change this file, since it can be overwritten.
 * Instead, change the Users/Referred.js file.
 *
 * @module Users
 */
...
/**
 * Base class representing 'Referred' rows in the 'Users' database
 ...
 */
/**
 * @property toCommunityId
 * @type String|Buffer
 * @default ""
 * 
 */
/**
 * @property referredByUserId
 * @type String|Buffer
 * @default ""
 * 
 */
...
Base.table = function (withoutDbName) {
	if (Q.Config.get(['Db', 'connections', 'Users', 'indexes', 'Referred'], false)) {
		return new Db.Expression((withoutDbName ? '' : '{{dbname}}.')+'{{prefix}}referred');
	} else {
		var conn = Db.getConnection('Users');
		var prefix = conn.prefix || '';
		var tableName = prefix + 'referred';
 ...
 * @type string
 */
Base.prototype.className = "Users_Referred";
 ...
 * Method is called before setting the field and verifies if value is string of length within acceptable limit.
 * Optionally accept numeric value which is converted to string
 * @method beforeSet_toCommunityId
 * @param {string} value
 * @return {string} The value
 * @throws {Error} An exception is thrown if 'value' is not string or is exceedingly long
 */
Base.prototype.beforeSet_toCommunityId = function (value) {
		if (value == null) {
			value='';
		}
		if (value instanceof Db.Expression) return value;
		if (typeof value !== "string" && typeof value !== "number" && !(value instanceof Buffer))
			throw new Error('Must pass a String or Buffer to '+this.table()+".toCommunityId");
		if (typeof value === "string" && value.length > 31)
			throw new Error('Exceedingly long value being assigned to '+this.table()+".toCommunityId");
		return value;
};

	/**
	 * Returns the maximum string length that can be assigned to the toCommunityId field
	 * @return {integer}
	 */
Base.prototype.maxSize_toCommunityId = function () {

		return 31;
};

	/**
	 * Returns schema information for toCommunityId column
	 * @return {array} [[typeName, displayRange, modifiers, unsigned], isNull, key, default]
	 */
Base.column_toCommunityId = function () {
 ...
 * Method is called before setting the field and verifies if value is string of length within acceptable limit.
 * Optionally accept numeric value which is converted to string
 * @method beforeSet_referredByUserId
 * @param {string} value
 * @return {string} The value
 * @throws {Error} An exception is thrown if 'value' is not string or is exceedingly long
 */
Base.prototype.beforeSet_referredByUserId = function (value) {
		if (value == null) {
			value='';
		}
		if (value instanceof Db.Expression) return value;
		if (typeof value !== "string" && typeof value !== "number" && !(value instanceof Buffer))
			throw new Error('Must pass a String or Buffer to '+this.table()+".referredByUserId");
		if (typeof value === "string" && value.length > 31)
			throw new Error('Exceedingly long value being assigned to '+this.table()+".referredByUserId");
		return value;
};

	/**
	 * Returns the maximum string length that can be assigned to the referredByUserId field
	 * @return {integer}
	 */
Base.prototype.maxSize_referredByUserId = function () {

		return 31;
};

	/**
	 * Returns schema information for referredByUserId column
	 * @return {array} [[typeName, displayRange, modifiers, unsigned], isNull, key, default]
	 */
Base.column_referredByUserId = function () {
...
Base.prototype.beforeSave = function (value) {
	var fields = ['userId','toCommunityId','referredByUserId'], i;
	if (!this._retrieved) {
	...
	if (this.fields["toCommunityId"] == undefined && value["toCommunityId"] == undefined) {
		this.fields["toCommunityId"] = value["toCommunityId"] = "";
	}
	if (this.fields["referredByUserId"] == undefined && value["referredByUserId"] == undefined) {
		this.fields["referredByUserId"] = value["referredByUserId"] = "";
	}
	return value;
};
